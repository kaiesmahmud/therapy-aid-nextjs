  ...
  return (
    <div className={`${(i%2==0)? 'bg-sky-100' : "bg-pink-100"} shadow-lg p-2 md:p-5  rounded-lg text-grey-700 transition-all ease-in duration-200 flex flex-col justify-between`}>
        ...
        <div className="mt-5 text-xs">
            ...
            <h3 className="text-xl md:text-2xl lg:text-3xl font-medium mb-3">{details.title}</h3>
            <h4 className="text-base md:text-lg font-medium ">Purpose:</h4>
            <p className="text-sm lg:text-md text-slate-800/80 mb-2 text-justify leading-5 p-2">{details.purpose}</p>
            {
                open && (
                    <div>
                        <h4 className=" text-base md:text-lg font-medium ">Provide:</h4>
                        <p className="text-sm lg:text-md text-slate-800/80  mb-2 text-justify leading-5 p-1">{details.provided}</p>
